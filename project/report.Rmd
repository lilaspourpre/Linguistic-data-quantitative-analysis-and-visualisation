...
We also ran a set of t-tests for discovering dependency of Russian, French and Russian+French mean embarrassement recognition values on each parameter. The following code is run to calculate the t-test results:
```
#gender
