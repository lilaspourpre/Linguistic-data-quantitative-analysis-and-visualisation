---
title: "Speech emotion analysis: embarrasment detection for French and Russian"
date: 10.06.2018
...
Our dataset comprises 216 responces from questionnaire (described below). 
...
str(embarr)
```
* Our dependent variable is MERV -- mean embarrassement recognition value: average score for all/French/Russian audios 
