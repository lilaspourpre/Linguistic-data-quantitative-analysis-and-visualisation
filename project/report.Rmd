...
We also ran a set of t-tests for discovering dependency of Russian, French and Russian+French mean embarrassement recognition values on each parameter. The results might be seen in the table below:

| Parameters | t-value (RU) | p-value (RU) | t-value (FR) | p-value (FR) | t-value (FR+RU) | p-value (FR+RU) | Statistically significant|
| --- | --- | --- | --- | --- | --- | --- | --- | 
| Gender | 0.220 | 0.982 | -0.498 | 0.619 | -0.317 | 0.752 || 
| Education | -1.517 | 0.130 | -0.964 | 0.336 | -1.559 | 0.12 || 
| English | -0.542 | 0.589 | -2.87 | 0.004 | -2.230 | 0.027 | * |
| French | -0.823 | 0.411| 1.470 | 0.140 | 1.470 | 0.14 ||
