...
```{r RuAndFr}
embarr.FrRu <- c(embarr$A1.1,embarr$A1.2, embarr$B1.1, embarr$B1.2, embarr$C1.1, embarr$C1.2, embarr$D1.1, embarr$D1.2, embarr$E1.1, embarr$E1.2, embarr$A2.1,embarr$A2.2, embarr$B2.1, embarr$B2.2, embarr$C2.1, embarr$C2.2, embarr$D2.1, embarr$D2.2, embarr$E2.1, embarr$E2.2)
embarr.lang <- c(rep("ru", times=2160),rep("fr", times=2160))
embarr.FrRu.Sums <- data.frame(embarr.FrRu, embarr.lang)
```
...
```{r RuAndFr}
embarr.FrRu.Sums %>% 
  ggplot(aes(embarr.FrRu, fill = embarr.lang, color = embarr.lang))+
...
```{r RuAndFr}
t.test(embarr.FrRu.Sums[embarr.FrRu.Sums$embarr.lang == "ru", ]$embarr.FrRu,
       embarr.FrRu.Sums[embarr.FrRu.Sums$embarr.lang == "fr", ]$embarr.FrRu)
```
